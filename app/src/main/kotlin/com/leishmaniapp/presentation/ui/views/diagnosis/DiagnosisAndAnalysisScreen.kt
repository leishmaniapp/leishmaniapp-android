...
import com.leishmaniapp.presentation.ui.composables.DiagnosisActionBar
...
fun DiagnosisAndAnalysisScreen(
    ...
    analysisStatus: ImageAnalysisStage,
    onNextAction: () -> Unit,
    onFinishAction: () -> Unit,
        ...
        DiagnosisActionBar(
            ...
            nextAction = {
                when (image.processed) {
                    ImageAnalysisStage.NotAnalyzed, ImageAnalysisStage.Analyzing -> coroutineScope.launch {
                    ...
                    ImageAnalysisStage.Deferred, ImageAnalysisStage.Analyzed -> onNextAction.invoke()
                }
            },
                    ...
                    DiagnosisAndAnalysisPages.ResultsPage -> {
                        Column(
                            ...
                            DiagnosticImageResultsTable(modifier = Modifier.padding(vertical = 8.dp),
                                ...
                                modelFailIcon = image.processed == ImageAnalysisStage.NotAnalyzed,
...
fun DiagnosisAndAnalysisPreview_NotAnalyzed() {
    LeishmaniappTheme {
        DiagnosisAndAnalysisScreen(
            ...
            onRepeatAction = {},
            onImageChange = {},
            analysisStatus = ImageAnalysisStage.NotAnalyzed
        )
    }
}
