    ...
    Column(
        ...
        Column(
            ...
            when (image.processed) {
                ImageAnalysisStage.NotAnalyzed -> Row(modifier = Modifier.padding(16.dp)) {
                    Icon(
                        Icons.Filled.Error,
                ...
                ImageAnalysisStage.Analyzing -> Row(modifier = Modifier.padding(16.dp)) {
                    Icon(
                        Icons.Filled.Sync,
                ...
                ImageAnalysisStage.Deferred -> Row(modifier = Modifier.padding(16.dp)) {
                    Icon(
                        Icons.Filled.Error,
                ...
                ImageAnalysisStage.Analyzed -> TextButton(
...
fun DiagnosticImageSectionPreview_NotProcessed() {
    LeishmaniappTheme {
        DiagnosticImageSection(
            image = MockGenerator.mockImage(ImageAnalysisStage.NotAnalyzed),
            onImageEdit = {}
        ) {}
    }
}
...
fun DiagnosticImageSectionPreview_Processing() {
    LeishmaniappTheme {
        DiagnosticImageSection(
            image = MockGenerator.mockImage(ImageAnalysisStage.Analyzing),
            onImageEdit = {}
        ) {}
    }
}
...
fun DiagnosticImageSectionPreview_Processed() {
    LeishmaniappTheme {
        DiagnosticImageSection(
            image = MockGenerator.mockImage(ImageAnalysisStage.Analyzed),
            onImageEdit = {}
        ) {}
    }
}
...
fun DiagnosticImageSectionPreview_Deferred() {
    LeishmaniappTheme {
        DiagnosticImageSection(
            image = MockGenerator.mockImage(ImageAnalysisStage.Deferred),
            onImageEdit = {}
        ) {}
    }
}
