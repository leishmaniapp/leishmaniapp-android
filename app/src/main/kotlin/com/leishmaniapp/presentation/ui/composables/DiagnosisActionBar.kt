...
fun DiagnosisActionBar(
    ...
    nextAction: () -> Unit,
    finishAction: () -> Unit,
    analysisStatus: ImageAnalysisStage = ImageAnalysisStage.NotAnalyzed,
    ...
    NavigationBar {
        ...
        NavigationBarItem(
            enabled = analysisStatus == ImageAnalysisStage.NotAnalyzed,
            selected = false,
            ...
            icon = {
                if (analysisShowAsLoading && analysisStatus == ImageAnalysisStage.NotAnalyzed) {
        ...
        NavigationBarItem(
            ...
            icon = {
                Icon(
                    if (analysisStatus == ImageAnalysisStage.Deferred ||
                        analysisStatus == ImageAnalysisStage.Analyzed
                    ) {
