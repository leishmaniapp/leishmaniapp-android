...
//
//        NavigationBarItem(
//            enabled = analysisStage == ImageAnalysisStage.NotAnalyzed,
//            selected = false,
//            onClick = if (analysisShowAsLoading
//                && analysisStage == ImageAnalysisStage.NotAnalyzed
//            ) {
//                {}
//            } else {
//                analyzeAction
//            },
//            icon = {
//                if (analysisShowAsLoading && analysisStage == ImageAnalysisStage.NotAnalyzed) {
...
//            icon = {
//                Icon(
//                    if (analysisStage == ImageAnalysisStage.Deferred ||
//                        analysisStage == ImageAnalysisStage.Analyzed
//                    ) {
